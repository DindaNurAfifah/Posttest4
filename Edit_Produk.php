<?php include('form.php');
    ...
    if(isset($_GET['Kode_Produk'])) {
        ...
        if(!count($data)) {
            echo "<script>alert('Data Tidak Ditemukan !');window.location='indexx.php';</script>";
        }

    } else {
        echo "<script>alert('Masukan Kode Produk yang Akan di Edit');window.location='indexx.php';</script>";
    }
